...
error.bar(img_obj, 
          c(mean(untreated_p27_expression),mean(negativeControl_p27_expression),mean(treated_p27_expression)),
          c(sd(untreated_p27_expression),sd(negativeControl_p27_expression),sd(treated_p27_expression)))
...
see$p.value
#Based on the experiment which included negative control,
#which of the following statements regarding the impact of the drug on p27 expression is true?

# - There is statistically significant up-regulation in p27 expression between un-treaded control
and negative control as well as un-treated control and treated cells. Therefore this 
experiment casts doubt on the conclusion stating that drug up- regulates p27 espression.
IT could be that other compandd in drug vehicile mixture is  stimulating expession.
